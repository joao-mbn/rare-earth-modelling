...
export const MODEL_CONSTANTS = [
  {
    materialId: 1, type: 'etr', shortString: 'dysprosium', longString: 'Dysprosium', symbol: 'Dy', defaultProperties: [
      { propertyId: 4, propertyLongString: 'Model Coefficient', uomId: 0, uomLongString: 'Dimensionless', value: 1.111, description: 'a' },
      { propertyId: 4, propertyLongString: 'Model Coefficient', uomId: 0, uomLongString: 'Dimensionless', value: 2.222, description: 'b' },
      { propertyId: 2, propertyLongString: 'ETR Concentration', uomId: 10, uomLongString: 'g/L of Oxide', value: 3.18, description: 'Initial Aqueous Concentration' },
      { propertyId: 2, propertyLongString: 'ETR Concentration', uomId: 10, uomLongString: 'g/L of Oxide', value: 0, description: 'Initial Organic Concentration' },
    ]
  },
  {
    materialId: 2, type: 'etr', shortString: 'holmium', longString: 'Holmium', symbol: 'Ho', defaultProperties: [
      { propertyId: 4, propertyLongString: 'Model Coefficient', uomId: 0, uomLongString: 'Dimensionless', value: 2.111, description: 'a' },
      { propertyId: 4, propertyLongString: 'Model Coefficient', uomId: 0, uomLongString: 'Dimensionless', value: 3.222, description: 'b' },
      { propertyId: 2, propertyLongString: 'ETR Concentration', uomId: 10, uomLongString: 'g/L of Oxide', value: 5.97, description: 'Initial Aqueous Concentration' },
      { propertyId: 2, propertyLongString: 'ETR Concentration', uomId: 10, uomLongString: 'g/L of Oxide', value: 0, description: 'Initial Organic Concentration' },
    ]
  },
];
