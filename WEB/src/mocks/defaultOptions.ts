...
export const ETRS = [
  { materialId: 1, type: 'etr', shortString: 'dysprosium', longString: 'Dysprosium', symbol: 'Dy', defaultProperties: [{ propertyId: 1, uomId: 1, propertyLongString: 'Price', uomLongString: 'USD/Kg', description: 'Price', value: 200 }] },
  { materialId: 2, type: 'etr', shortString: 'holmium', longString: 'Holmium', symbol: 'Ho', defaultProperties: [{ propertyId: 1, uomId: 1, propertyLongString: 'Price', uomLongString: 'USD/Kg', description: 'Price', value: 30 }] },
  { materialId: 3, type: 'etr', shortString: 'yttrium', longString: 'Yttrium', symbol: 'Y', defaultProperties: [{ propertyId: 1, uomId: 1, propertyLongString: 'Price', uomLongString: 'USD/Kg', description: 'Price', value: 50 }] },
  { materialId: 4, type: 'etr', shortString: 'neodymium', longString: 'Neodymium', symbol: 'Nd', defaultProperties: [{ propertyId: 1, uomId: 1, propertyLongString: 'Price', uomLongString: 'USD/Kg', description: 'Price', value: 80 }] },
  { materialId: 5, type: 'etr', shortString: 'samarium', longString: 'Samarium', symbol: 'Sm', defaultProperties: [{ propertyId: 1, uomId: 1, propertyLongString: 'Price', uomLongString: 'USD/Kg', description: 'Price', value: 25 }] },
]

export const ACIDS = [
  { materialId: 6, type: 'acid', shortString: 'hcl', longString: 'Hydrochloric Acid', symbol: 'HCl', isDefaultOption: true, defaultProperties: [{ propertyId: 1, uomId: 2, propertyLongString: 'Price', uomLongString: 'USD/L', description: 'Price', value: 0.75 }] },
  { materialId: 7, type: 'acid', shortString: 'h2so4', longString: 'Sulfuric Acid', symbol: 'H2SO4', isDefaultOption: false, defaultProperties: [{ propertyId: 1, uomId: 2, propertyLongString: 'Price', uomLongString: 'USD/L', description: 'Price', value: 0.55 }] },
  { materialId: 8, type: 'acid', shortString: 'hno3', longString: 'Nitric Acid', symbol: 'HNO3', isDefaultOption: false, defaultProperties: [{ propertyId: 1, uomId: 2, propertyLongString: 'Price', uomLongString: 'USD/L', description: 'Price', value: 1.15 }] },
]

export const BASES = [
  { materialId: 9, type: 'base', shortString: 'naoh', longString: 'Sodium Hydroxide', symbol: 'NaOH', isDefaultOption: true, defaultProperties: [{ propertyId: 1, uomId: 1, propertyLongString: 'Price', uomLongString: 'USD/Kg', description: 'Price', value: 1.25 }] },
  { materialId: 10, type: 'base', shortString: 'nh4oh', longString: 'Ammonium Hydroxide', symbol: 'NH4OH', isDefaultOption: false, defaultProperties: [{ propertyId: 1, uomId: 1, propertyLongString: 'Price', uomLongString: 'USD/Kg', description: 'Price', value: 2.55 }] },
]

export const EXTRACTANT = [
  { materialId: 11, type: 'extractant', shortString: 'd2ehpa', longString: 'D2EHPA', symbol: 'D2EHPA', isDefaultOption: false, defaultProperties: [{ propertyId: 1, uomId: 2, propertyLongString: 'Price', uomLongString: 'USD/L', description: 'Price', value: 8.5 }] },
  { materialId: 12, type: 'extractant', shortString: 'p507', longString: 'P507', symbol: 'P507', isDefaultOption: false, defaultProperties: [{ propertyId: 1, uomId: 2, propertyLongString: 'Price', uomLongString: 'USD/L', description: 'Price', value: 17.85 }] },
]

export const SOLVENT = [
  { materialId: 13, type: 'solvent', shortString: 'isoparaffin', longString: 'Isoparaffin', isDefaultOption: true, defaultProperties: [{ propertyId: 1, uomId: 2, propertyLongString: 'Price', uomLongString: 'USD/L', description: 'Price', value: 2.10 }] },
]

export const CELLS = [
  { materialId: 14, type: 'cell', shortString: 'mix-settle', longString: 'Mix-Settle Cell', isDefaultOption: true, defaultProperties: [{ propertyId: 1, uomId: 3, propertyLongString: 'Price', uomLongString: 'USD/Un.', description: 'Price', value: 550 }] },
]
