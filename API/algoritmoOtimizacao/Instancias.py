from algoritmoOtimizacao.SubstanciaClass import Substancia
...
from algoritmoOtimizacao.OperacaoClass import Operacao
...
isotherm_dto = Isoterma(40, 0.6, [H, disprosio, holmio]).create_isotherm_results_dto()
